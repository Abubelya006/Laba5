...
namespace Project2kurs_4laba {
	...
	public:
		...
		AddEditTariffForm(Tariff^ tariffToEdit)// Заполняет форму для редактирования + меняет заголовок формы
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			// Установка цвета фона формы
			this->BackColor = System::Drawing::Color::FromArgb(255, 182, 193); // Нежно-розовый цвет
